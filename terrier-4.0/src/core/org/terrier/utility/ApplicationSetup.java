...
public class ApplicationSetup {
	...
	*/
	...
	protected static final Properties UsedAppProperties = new Properties();;
         /*Added By Meltem 28092014
        terrier.properties dosyasının içeriğini veri tabanına atmak için eklenmiştir. 
        */
        protected static  String tcPropertiesStream = "";
        public static String gettcPropertiesStream()
	{
		return tcPropertiesStream;
	}
        /*Added By Meltem 28092014*/	
	...
	private static Context envCtx = null;
        /// Added By Meltem 30102014
        static Properties tcprops = null;
        /// Added By Meltem 30102014
        public static Properties LoadInitialConfigFile()
        {
            ...
            try
            {
                ...
                {
                    sFileName = (new java.io.File("")).getAbsolutePath() + "\\TrMedConfig.properties";
                }
                else
                {
			...
			System.out.println("WARNING: The file TrMedConfig was not found at location "+ sFileName);
                }
            catch (java.io.IOException fnfe) {
			System.out.println("WARNING: Error Reading File "+ sFileName);
                }
            return configFile;
        }
	...
	public static void bootstrapInitialisation()
	{
		...
		String terrier_etc = null;
               // Added by Meltem 30102014
                tcprops = LoadInitialConfigFile();
                terrier_home = tcprops.getProperty("terrierHome");
             // terrier_home = "D:\\terrier_home_v4\\";
                // terrier_home = "C:\\terrier_home_v4\\terrier-4.0-win\\";
            // Added by Meltem 30102014
		...
		try {
			...
			{
				terrier_home = System.getProperty("terrier.home", terrier_home);
				//terrier_etc = System.getProperty("terrier.etc", terrier_home +FILE_SEPARATOR+"etc");
                                // Added By Meltem 30102014
                                terrier_etc = System.getProperty("terrier.etc", terrier_home +FILE_SEPARATOR+tcprops.getProperty("demirtcEtc", "etc"));
                                // Added By Meltem 30102014
			...
			in.close();
                        ...
                        /*Added By Meltem 28092014*/
                        FileInputStream intc = new FileInputStream(propertiesFile);
                        InputStreamReader is = new InputStreamReader(intc);
                        ...
                        tcPropertiesStream = sb.toString();
                        intc.close();    
                        /*Added By Meltem 28092014*/
	...
	public static void loadCommonProperties()
	{
		...
		// TERRIER_VAR = makeAbsolute( getProperty("terrier.var","var"), TERRIER_HOME);
            /// Added By Meltem 30102014
		TERRIER_ETC = makeAbsolute( getProperty("terrier.etc",tcprops.getProperty("demirtcEtc", "etc")), TERRIER_HOME);
		TERRIER_VAR = makeAbsolute( getProperty("terrier.var",tcprops.getProperty("demirtcVar", "var")), TERRIER_HOME);
